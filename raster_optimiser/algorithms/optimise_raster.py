...
class OptimiseRasterAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        return self.tr(
            ...
            "size. The output is always a Cloud Optimized GeoTIFF "
            ...
            "Use it for basemaps, client copies, QField "
            ...
            "unchanged.</p>"
            "<p>Not every file can be compressed for viewing. Elevation, "
